    ...
    where TAudit : class, IIntKeyedEntity
{
    ...
    private void AddUpdateDataActions(List<IAuditAction> list)
    {
        ...
        {
            var resultAction = ActionFactory.CreateAuditAction(modelData.ActionType, modelData.EntityId, modelData.UserId, modelData.NewAction.Id, modelData.OldAction.Id, modelData.OverrideLogin, null, DateTime.Now);
            list.Add(resultAction);
        }
    }
    private void AddDeleteDataActions(List<IAuditAction> list)
    {
        ...
        {
            var resultAction = ActionFactory.CreateAuditAction(modelData.ActionType, modelData.EntityId, modelData.UserId, null, modelData.Action.Id, modelData.OverrideLogin, null, DateTime.Now);
            list.Add(resultAction);
        }
    }
